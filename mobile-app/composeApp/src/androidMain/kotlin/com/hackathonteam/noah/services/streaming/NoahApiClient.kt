...
GoldRen — 08:27
Vous avez pas mal bossé cette bande de fous
Goatesque
GoldRen — 09:53
Du coup s’il reste a faire l’UI avec Vibe je veux bien le faire
Theo

— 10:21
Je suis chaud si tu veux faire l'UI
Mais est-ce que tu as la possibilité d'installer Android Studio sur mac?
Si c'est le cas, c'est cool car ça te permettra de simuler même si tu n'est pas sur Android 
GoldRen — 10:47
c good download finit, je clone le repo github simplement ?
Theo

— 10:48
Alors j'ai fait un petit trick perso, j'ai clone mais j'ai lancé le android studio uniquement sur le dossier mobile-app 
Et j'ai relié sur git le dossier mobile-app à la racine du repo pour qu'il reconnaisse quand même le git si je suis dans le sous-dossier
GoldRen — 10:53
suis dessus, je vois pour tester tout ça
Theo
...
— 11:51
go voc sur le discord
Theo

— 13:05
Infos pour mistral vibe:
Il faut que l'UI soit facilement accessible pour les personnes aveugles et analphabètes. Certains s'appuieront sur la lecture automatique de l'écran et il faudra donc une accessibilité améliorée des éléments: boutons larges et gros, icones en priorité, peu de texte mais une description pour chaque balise (contentDescription) afin que la lecture automatique de l'écran soit facilitée.
Nous utilisons Jetpack compose comme framework et il doit s'appuyer sur les components de Jetpack compose.
Les couleurs doivent être dans les couleurs de Mistral (bonus de points?)
Si tu veux:
https://developer.android.com/guide/topics/ui/accessibility/apps
Android Developers
Make apps more accessible  |  App quality  |  Android Developers
This document provides guidelines for implementing key accessibility features in Android apps, aiming to improve the user experience for individuals with various disabilities by focusing on design aspects like text visibility, control size, and UI element descriptions.
Make apps more accessible  |  App quality  |  Android Developers
GoldRen — 13:30
au passage t'es bien dans ma team ?
Theo
...
Image
GoldRen — 14:01
on est d'accord si je modifie un fichier je dois rebuild ?
Theo

— 14:08
oui
mais uniquement le logo en haut à droite
pas le gradle
GoldRen — 14:10
bah c'et très chelou parce que j'ai modifier la first view avec vibe mais Andoi studio ne détecte pas le chanegement
Theo

— 14:10
fais un partage
GoldRen — 14:14
/Users/tobiasnobile/StudioProjects/noah/mobile-app/mobile-app/composeApp/src/androidMain/kotlin/com/hackathonteam/noah/ui/components/FirstView.kt
/Users/tobiasnobile/Documents/NeuraTN/mistral-hackathon/noah/mobile-app/composeApp/src/androidMain/kotlin/com/hackathonteam/noah/ui/components/FirstView.kt
Theo

— 14:15
/Users/tobiasnobile/StudioProjects/noah/mobile-app/mobile-app/
Theo
...
— 15:47
https://huggingface.co/mistralai/Devstral-2-123B-Instruct-2512/blob/main/VIBE_SYSTEM_PROMPT.txt
VIBE_SYSTEM_PROMPT.txt · mistralai/Devstral-2-123B-Instruct-2512 a...
We’re on a journey to advance and democratize artificial intelligence through open source and open science.
VIBE_SYSTEM_PROMPT.txt · mistralai/Devstral-2-123B-Instruct-2512 a...
GoldRen — 16:06
Image
GoldRen — 17:15
okay fais moi un petit brieifing pour les settings : querls fichieirs à modifier, et quels fichiers à ajouter
GoldRen — 17:28
du coup ?
Theo
...
— 17:31
Settings:
ajouter un boutton paramètres stylé (pas une image car image pas pris en compte par le talkback d'accessibilité) qui ramènera l'utilisateur sur une nouvelle vue:
la vue contiendra seulement un textarea pour le port et un textarea pour l'ip.
le textarea met à jour la valeur interne stockée en dur dans le internal storage de l'app (getFilesDir()), il faut vrm appuyer pour que le LLM te le fasse là bas car pas besoin de créer une bdd juste pour ça. Au lancement de l'application, les données sont récupérées (si existantes sinon localhost:32666 par défaut).
si on édit le textarea, le internal storage est aussi mis à jour
il faut que BASE_URL dans NoahApiClient soit égal à ce qui est mis dans les textareas.
voilà globalement
et ça aurait été bien je pense de faire en sorte que le bouton soit plus large car ça fait un peu bizarre qu'il soit aussi étiré mais seulement en hauteur, no?
GoldRen — 17:32
d'acc, où se situe le interla storage dans le projet ? j'ai fouillé mais pas toruvé
Theo

— 17:33
y'en a pas, c'est accessible via l'api Android
(getFilesDir())
